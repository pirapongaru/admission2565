...
session_start();
$_SESSION['page'] = 'm1-4';
if ($_SESSION['where'] != 'm1' && $_SESSION['where'] != 'edit') {
...
// Upload DOC Location
$location = "stddoc/m1/";
$std_photo = 'stdphoto/m1/' . $std_id . '.jpg';
            ...
            <div class="row cnbox">
                <div class="col-12 cnbox bg-success text-center">
                    ...
                    if ($_SESSION['mode'] == "add") {
                        ...
                        // echo '</pre>';
                        include 'includes/config.php';
                        $query = "INSERT INTO studentm1 (std_id, std_type, std_dayb, std_monthb, std_yearb, std_age, std_prefix,
                            ...
                            <div>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="m1start.php">ชั้นมัธยมศึกษาปีที่ 1</a></li>
                    ...
                    if ($_SESSION['mode'] == "update") {
                        ...
                        if ($stmt->execute()) {
                            ...
                            <?php
                            include 'includes/config.php';
                            $sql = "SELECT * FROM studentm1 INNER JOIN registype ON studentm1.std_type=registype.type_id WHERE std_id=:std_id";

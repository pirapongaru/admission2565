...
if (isset($_POST['login'])) {
    ...
    if ($query->rowCount() == 0) {
        ...
        // echo "alert('ข้อมูลไม่ถูกต้อง');window.location='admin.php';";
        echo "</script>";
    } else {
        if ($uname == "adminm1") {
            $_SESSION['admindo'] = 'm1';
            $_SESSION['admin_computer'] = $row->admin_computer;
            echo "<script type='text/javascript'> document.location = 'adminm1.php'; </script>";
        } else if ($uname == "adminm4") {
            $_SESSION['admindo'] = 'm4';
            $_SESSION['admin_computer'] = $row->admin_computer;
            echo "<script type='text/javascript'> document.location = 'adminm4.php'; </script>";
        }
    }
} else {
?>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row cnbox">
                    <div class="col col-lg-12 cnbox bg-info text-center"><br>
                        <?php
                        include 'includes/config.php';
                        ...
                        <form method="POST">
                            <h1>เจ้าหน้าที่ตรวจสอบข้อมูล</h1>
                            <fieldset>

...
if (isset($_POST['submit'])) {
  ...
  if (strlen($std_id) != 13) {
    ...
    if ($query->rowCount() != 0) {
      ...
      echo "<script type='text/javascript'> document.location = 'm1frm.php'; </script>";
    }
  }
} else {
?>
            ...
            <div>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">ชั้นมัธยมศึกษาปีที่ 1</li>
                </ol>
              </nav>
            </div>
          </div>

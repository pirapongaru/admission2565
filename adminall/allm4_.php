...
<body>
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            <a href="allm1_.php" class="btn btn-primary">
                <i class="ace-icon fa fa fa-pencil-square-o bigger-100"></i>ม.1
            </a>
            <a href="allm4_.php" class="btn btn-primary">
            ...
            <table id="editable_table" class="table table-bordered table-striped text-center" style="width:99%;">
                <thead>
                    <tr>
                        ...
                        <th width="10%">เบอร์บิดา</th>
                        <th width="10%">เบอร์มารดา</th>
                        <th width="10%">เบอร์ผปค.</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '
                            ...
                            <td class="text-left bigger-120">' . $row["std_father_phone"] . '</td>
                            <td class="text-left bigger-120">' . $row["std_mother_phone"] . '</td>
                            <td class="text-left bigger-120">' . $row["std_parent_phone"] . '</td>
                            </tr>
                            ';
                    }
                    ?>

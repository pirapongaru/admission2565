                                                ...
                                                <div class="row text-center">
                                                    <div class="col-12 bg-info" style="text-align:center;margin: 5px;border: 2px solid #bce8f1;">
                                                        ...
                                                        if (file_exists($rowstd->std_doccer)) {
                                                            ...
                                                            ?>
                                                                <a href="<?php echo $rowstd->std_doccer . '?' . date("y-m-d-h-i-s"); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo $rowstd->std_doccer . '?' . date("y-m-d-h-i-s"); ?>" width="90%"></a>
                                                        <?php
                                                            }
                                                        } else {
                                                            echo '<img src="stddoc/nofile.png" width="20%"><br>ไม่พบเอกสารนี้<br>';
                                                        ...
                                                        if (file_exists($rowstd->std_doccer_2)) {
                                                            ...
                                                            ?>
                                                                <a href="<?php echo $rowstd->std_doccer_2 . '?' . date("y-m-d-h-i-s"); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo $rowstd->std_doccer_2 . '?' . date("y-m-d-h-i-s"); ?>" width="90%"></a>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div id="formdocfile" style="display:none;">
                                                    <div class="col-12 bg-info" style="text-align:center;margin: 5px;border: 2px solid #bce8f1;">
                                                        ...
                                                        if (file_exists($rowstd->std_dochome1)) {
                                                            ...
                                                            ?>
                                                                <a href="<?php echo $rowstd->std_dochome1. '?' . date("y-m-d-h-i-s");; ?>" target="_blank"><img src="<?php echo $rowstd->std_dochome1 . '?' . date("y-m-d-h-i-s"); ?>" width="90%"></a>
                                                        <?php
                                                            }
                                                        } else {
                                                            echo '<img src="stddoc/nofile.png" width="20%"><br>ไม่พบเอกสารนี้<br>';
                                                    ...
                                                    if (file_exists($rowstd->std_doccer_3)) {
                                                        ...
                                                        ?>
                                                            <a href="<?php echo $rowstd->std_doccer_3 . '?' . date("y-m-d-h-i-s"); ?>" target="_blank" rel="noopener noreferrer">
                                                                <img src="<?php echo $rowstd->std_doccer_3 . '?' . date("y-m-d-h-i-s"); ?>" width="90%">
                                                            </a>
                                                    <?php
                                                        }
                                                        echo '</div>';
                                                    ...
                                                    if (file_exists($rowstd->std_doccer_4)) {
                                                        ...
                                                        ?>
                                                            <a href="<?php echo $rowstd->std_doccer_4 . '?' . date("y-m-d-h-i-s"); ?>" target="_blank" rel="noopener noreferrer">
                                                                <img src="<?php echo $rowstd->std_doccer_4 . '?' . date("y-m-d-h-i-s"); ?>" width="90%">
                                                            </a>
                                                    <?php
                                                        }
                                                        echo '</div>';

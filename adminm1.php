    ...
    <div class="main-content-inner">
        <div class="page-content">
            <div class="page-header ">
                <h1>
                    เจ้าหน้าที่ตรวจสอบข้อมูล ชั้นมัธยมศึกษาปีที่ 1
                </h1>
            </div><!-- /.page-header -->
                ...
                <div class="col-12 cnbox bg-info text-center">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            <a href="adminall/m1.php" class="btn btn-yellow">
                    ...
                    <div>
                        ...
                        <h1>สถานะผู้สมัคร ม.1</h1>
                        <hr style="border-color: green; width: 50%;">
                        <h2>ตรวจสอบข้อมูล</h2>
                        <form action="adminm1.php" method="GET">
                        ...
                        <table id="table-1" class="table table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    if ($row->std_status == '0') {
                                        $std_checkstatus = '<td>' . '<a href="adminm1std.php?std_id=' . $row->std_id . '" class="badge badge-primary">ตรวจสอบ</a>' . '</td>';
                                    } else if ($row->std_status == '1') {
                                        $std_checkstatus = '<td>' .
                                            // '<a #href="#" class="btn btn-minier btn-success">ผ่าน</a>' .
                                            '<a href="adminm1std.php?std_id=' . $row->std_id . '" class="badge badge-success">&nbsp;ดูข้อมูล&nbsp;</a>&nbsp;' .
                                            '</td>';
                                    } else if ($row->std_status == '3') {
                                        $std_checkstatus = '<td>' . '<a href="adminm1std.php?std_id=' . $row->std_id . '" class="badge badge-primary">ตรวจสอบ (แก้ไขแล้ว)</a>' . '</td>';
                                    } else if ($row->std_status == '2') {
                                        $std_checkstatus = '<td>' . '<a href="adminm1std.php?std_id=' . $row->std_id . '" class="badge badge-danger">รอแก้ไข</a>' . '</td>';
                                    } else if ($row->std_status == '4') {
                                        $std_checkstatus = '<td>' . '<a href="adminm1std.php?std_id=' . $row->std_id . '" class="badge badge-primary">ยืนยันข้อมูล/ออกหมายเลข</a>' . '</td>';
                                    }
